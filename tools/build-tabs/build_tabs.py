...
그냥 이어 붙이면 안 된다 — 세 문서가 .tier / .page / .stat 같은 클래스를
...
def render_tokens(docs_tokens):
    """세 문서의 토큰을 합쳐 전역 블록 하나씩으로 만든다. 먼저 나온 값이 이긴다."""
    light, dark, theme = {}, {}, {}
    per_panel = []
...
<div class="shell">
  <header class="brand">
    ...
    <h1>리서치 아카이브</h1>
    <p>기획안을 뒷받침하려고 진행한 세 단계입니다 &mdash; 시중 도구를 조사하고, 캡처 난이도 분류 체계를 세우고, 실제 사이트 50곳을 계측했습니다. 진행한 순서대로 정리했습니다.</p>
  </header>
</div>
